...
public class Pessoa {
    ...
    @Column (name = "numeroCtps", nullable = false, length = 11)
    private String numeroCtps;

    public Pessoa() {}

    public Pessoa(String nomeCompleto, String cpfCnpj, LocalDate dataNascimento,
                  String tipoPessoa, String numeroCtps) {
